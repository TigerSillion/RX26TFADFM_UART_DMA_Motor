...
#define ICU_SCI5_RXI5_PRIORITY                     (_0A_ICU_PRIORITY_LEVEL10)
#define ICU_SCI5_TXI5_PRIORITY                     (_0A_ICU_PRIORITY_LEVEL10)
...
#define ICU_ICU_GROUPBL0_PRIORITY                  (_0A_ICU_PRIORITY_LEVEL10)
